...
class Blastn(object):
    """
    @class  Blastn
    @brief  Singleton class allowing to perform de blast of a query against a blast database. If
    hits are found, a list of BlastHit objects is returned.
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    ...
    def __init__ (self, Blastdb, blastn_opt=None, blastn="blastn"):
        ...
        @param Blastdb Blast database object NewDB or Existing DB
        ...
        @param blastn Path ot the blastn executable. If blast+ if already added to your system path
...
class ExistingDB(object):
    """
    @class ExistingDB
    @brief Import an existing blastn database and verify the presence and size of database files.
    """
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
